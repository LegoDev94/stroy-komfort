...
export const services: Service[] = [
  ...
  },
  {
    ...
    short: "Снимаем все хлопоты по материалам с ваших плеч",
    description:
      "Берём на себя всю головную боль: поиск, подбор и согласование материалов с поставщиками, доставку и подъём на этаж. Вам остаётся только результат на объекте.",
